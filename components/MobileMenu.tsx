...
export default function MobileMenu({ playing, toggle }: Props) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex h-dvh w-[90vw] max-w-sm flex-col border-r border-yellow-500/20 bg-black shadow-[0_0_50px_rgba(255,210,0,0.15)] transition-transform duration-300 ${
      ...
      >
        ...
        <div className="shrink-0 border-b border-neutral-800 p-8">
        ...
        <nav
          className="flex-1 overflow-y-auto px-5 py-6 pb-40 overscroll-contain"
        >
        ...
        <div
          className="shrink-0 border-t border-neutral-800 bg-black p-6 pb-[calc(env(safe-area-inset-bottom)+110px)]"
        >
