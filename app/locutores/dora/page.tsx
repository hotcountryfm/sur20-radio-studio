        ...
        <div className="grid gap-16 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-8 text-lg leading-8 text-slate-300">
              Dora presenta "El Baúl de los Recuerdos", un espacio dedicado a
              revivir las canciones que marcaron nuestras vidas y que siguen
              despertando emociones generación tras generación.
            </p>
